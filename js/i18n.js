...
window.I18N = (function(){
  ...
  const dict = {
    en: {
      ...
      /* 小游戏 2 */
      'mg2.title': 'Mission 2: Underground Financial Trace',
      'mg2.timer': 'Time',
      'mg2.alarm': 'Alarm',
      'mg2.legend': 'Legend',
      'mg2.start': 'Start: Corporate Bank',
      'mg2.end': 'End: Bunker Coordinates',
      'mg2.pipe': 'Pipe Node (click to rotate 90°)',
      'mg2.trap': 'Firewall Trap (triggers alarm)',
      'mg2.reset': 'Reset Layout',
      'mg2.hint': 'Rotate nodes to connect Start to End before the timer runs out. Routing through a trap triggers an alarm; 3 alarms = failure.',
      'mg2.trapWarn': '⚠ Data flow hit a Firewall Trap! Alarm +1',
    ...
    zh: {
      ...
      'mg2.title': '行动二：地下资金链追查',
      'mg2.timer': '倒计时',
      'mg2.alarm': '警报',
      'mg2.legend': '图例',
      'mg2.start': '起点：企业银行',
      'mg2.end': '终点：避难所坐标',
      'mg2.pipe': '管道节点（点击旋转90°）',
      'mg2.trap': '防火墙陷阱（经过触发警报）',
      'mg2.reset': '重置布局',
      'mg2.hint': '在倒计时结束前，旋转节点将起点与终点连通。路径经过陷阱会触发警报，3次警报即失败。',
      'mg2.trapWarn': '⚠ 数据流触发防火墙陷阱！警报 +1',
